...
class Premise(pydantic.BaseModel):
    ...
    cultivate_land: int | None = pydantic.Field(default=None)
    cultivate_land_unit: str | None = pydantic.Field(default=None)
    borrowed_cultivate_land: int | None = pydantic.Field(default=None)
    owned_cultivate_land: int | None = pydantic.Field(default=None)
    labor_raw: str | None = pydantic.Field(default=None)
    labors: float | None = pydantic.Field(default=None)
    total_income: int | None = pydantic.Field(default=None)
