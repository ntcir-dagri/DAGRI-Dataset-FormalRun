...
_KEYWORDS = ["資本装備", "減価償却", "施設機械装備", "機械", "装備"]


def find_capital_equipment_pages(pages: list[PDFPage], llm_runtime) -> list[int]:
    ...
    response = llm_runtime.request_json(
        system_prompt="Find pages that describe capital equipment and depreciation.",
        user_prompt=(
            "From the candidate pages, select pages that contain capital equipment information.\n"
